...
class CompanyService
{
    ...
    public function __construct()
    {
        ...
        $this->modelCMS = new CompanyModel($cmsDB);
        $this->modelA = new CompanyModel($authenticationDB);
        $this->mail = new Mail2();
    }

    public function createCompany($company, $gstnum, $mobile, $email, $address, $state, $district, $pincode)
    {
        // sleep(20);
        //Check mail ID is already exit
        // $response1 = $this->modelA->getMailID($email);
        ...
        if (!$response3) {
            ...
            $this->modelCMS->deleteUser($company);
    ...
    public function updateCompany($company_id, $company, $gstnum, $mobile, $email, $address, $state, $district, $pincode)
    {
        ...
        //Check for changes
        $changes = [];
        $fields = ['company_name', 'gstnumber', 'company_phone', 'company_email', 'company_address', 'state', 'district', 'pincode'];
    ...
    public function getCompany($companyId)
    {
        ...
        $response = $this->modelCMS->getCompanyDetailss($companyId);
